...
public class AvaluadorTest_MitjanaSiSupera {
    ...
    public void testMitjanaSiSupera() throws Exception {
        ...
        assertEquals(mitjana,instance.mitjanaSiSupera(estudiant0), 0.01);
